...
const MensFashion = ({items, addItem}) => {
    ...
    async function req (){
        ...
        // console.log(items)
        aitem.push(<MenFashion items={items[i]} addItem={addItem}/>)
    ...
    return (
		...
		<h2 className="pb-0 text-center text-bold" style={{borderBottom : "1px solid green", "display" : "inline"}}>Men's Fashion</h2>
		<hr className="w-100" />
