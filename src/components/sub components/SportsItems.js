...
const SportsItems = ({items, addItem}) => {
    ...
    async function req (){
        ...
        // console.log(items)
        aitem.push(<SportItem items={items[i]} addItem={addItem}/>)
    ...
    return (
		...
		<h2 className="pb-0 text-center text-bold" style={{borderBottom : "1px solid green", "display" : "inline"}}>Sport Items</h2>
		<hr className="w-100" />
